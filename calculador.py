...
class App():
    ...
    def calculadora(self):
      ...
      # Resultado
       ...
       #Botão
        ...
        self.bt = Button(text="Sair",command=self.sair)
        self.bt.place(relx=0.85, rely=0.45)
    ...
    def div(self):
        ...
        num2 = self.numero2.get()
        if num2 == 0:
        	messagebox.showinfo("WARNING", "Não é possivel dividir um numero por 0")
